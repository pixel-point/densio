...
New organizations use 12-character alphanumeric Nano IDs. IDs are case-sensitive. Copy IDs exactly as returned by the API; never lowercase, truncate, or reconstruct them. Users, memberships, invitations, sources, plans, jobs, artifacts, videos, and storage operations use 21-character alphanumeric Nano IDs when generated by Densio. Treat IDs as opaque values throughout retries and local context.

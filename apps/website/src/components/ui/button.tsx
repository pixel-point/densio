    ...
    variants: {
      variant: {
        default: cn(
          ...
          "text-primary-foreground before:bg-black/15",
        ),
        destructive:
        ...
        secondary:
          "border border-secondary-foreground/10 before:-inset-px before:bg-black/5 bg-secondary text-secondary-foreground",
